...
const FeaturesSection = () => {
  ...
  const features = [
    {
      ...
      description:
        "AI-powered meal suggestions based on your dietary preferences, nutritional goals, and seasonal ingredients. Plan weeks ahead with automated grocery lists.",
      image:
    ...
    },
    {
      ...
      description:
        "Learn cooking techniques through engaging challenges and mini-games. Master knife skills, timing, and flavor combinations while earning achievements.",
      image:
    ...
    },
    {
      ...
      description:
        "Monitor macronutrients, vitamins, and minerals with detailed analytics. Set personalized goals and track your progress with beautiful visualizations.",
      image:
  ...
  return (
    <section
      ref={ref}
      className="relative py-20 bg-gradient-to-b from-orange-50 via-white to-amber-50 overflow-hidden"
    >
        ...
        >
          ...
          >
            ...
            <span className="ml-3 text-sm font-semibold text-gray-700">
              Powerful Culinary Features
            </span>
          </motion.div>

          <h2 className="text-[22px] sm:text-[30px] md:text-[32px] lg:text-[40px]  font-heading font-bold text-gray-800 mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Our comprehensive culinary platform combines meal planning, cooking
            education, and nutrition tracking to help you build lasting healthy
            cooking habits throughout the year.
          </p>
        </motion.div>
            ...
            >
              <div className="flex-1 space-y-8 relative">
                ...
                >
                  ...
                  <h3 className="text-[22px] sm:text-[30px] md:text-[32px] lg:text-[40px] font-heading font-bold text-gray-800">
                    {feature?.title}
                  </h3>
                </motion.div>
