...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      >
        <motion.div variants={fadeInUp} className="mb-8 mt-[2rem]">
          <motion.div
        ...
        <motion.h1
          variants={fadeInUp}
          className="text-[35px] sm:text-[40px] md:text-[45px] lg:text-[60px] font-heading text-center font-bold mb-8 leading-tight"
        >
          <motion.span
        ...
        >
          Join thousands who've transformed their culinary skills with our
          gamified cooking challenges, personalized meal planning, and
          interactive nutrition tracking system.
        </motion.p>
