        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Transform your nutrition journey with gamified meal planning, interactive cooking challenges, 
              and comprehensive tracking tools designed for lasting healthy habits.
            </p>
        ...
        <div className="bg-muted/30 rounded-2xl p-8 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Get weekly nutrition insights, healthy recipes, and exclusive cooking challenges 
          ...
          <div className="flex items-center space-x-6 mb-4 md:mb-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-primary font-medium">FDA Compliant</span>
              </div>
            </div>
          </div>
