...
const WeeklyCalendar = ({
  ...
  <div className="flex items-center space-x-1 sm:space-x-2">
      ...
      <div className="p-4 sm:p-6">
        <div className="grid grid-cols-8 gap-2 sm:gap-4 overflow-x-auto scrollbar-thin scrollbar-thumb-muted/40 scrollbar-track-transparent min-w-[700px] sm:min-w-0">
          {/* Header Row */}
      ...
      <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-border bg-muted/30">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-center">
          <div>
            ...
            <div className="text-[10px] sm:text-xs text-muted-foreground">Meals Planned</div>
          </div>
          <div>
            <div className="text-base sm:text-lg font-heading font-bold text-success">
              {plannedMeals?.reduce((sum, meal) => sum + meal?.calories, 0)}
            </div>
            <div className="text-[10px] sm:text-xs text-muted-foreground">Total Calories</div>
          </div>
          <div>
            ...
            <div className="text-[10px] sm:text-xs text-muted-foreground">Prep Time</div>
          </div>
          <div>
            <div className="text-base sm:text-lg font-heading font-bold text-accent">
              85%
            </div>
            <div className="text-[10px] sm:text-xs text-muted-foreground">Week Complete</div>
          </div>
        </div>
      </div>
    </div>
