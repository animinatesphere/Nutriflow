  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sign in to NutriFlow to continue your personalized nutrition tracking, meal planning, and cooking game adventures. Secure login with social options available."
        />
        <meta
          name="keywords"
          content="NutriFlow login, nutrition app signin, meal planning login, cooking games access"
        />
        <meta property="og:title" content="Sign In - NutriFlow" />
        <meta
          property="og:description"
          content="Access your personalized nutrition dashboard and continue your healthy eating journey"
        />
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
                ...
                >
                  <div className="max-w-lg">
                    ...
                    <p className="text-lg text-muted-foreground font-body mb-8 leading-relaxed">
                      ...
                      and discover new recipes tailored to your goals.
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-foreground font-body">
                          Play interactive cooking games
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          >
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              ...
              <div className=" grid grid-cols-2  lg:grid-cols-3 space-x-6">
                ...
                <button className="text-sm text-muted-foreground hover:text-foreground transition-colors font-body text-center">
                  Support
                </button>
              </div>
            </div>
